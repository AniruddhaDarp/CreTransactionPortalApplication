...
describe('DealsStack', () => {
  ...
  it('registers all 27 JWT-authorized routes', () => {
    t.resourceCountIs('AWS::ApiGatewayV2::Route', 27);
    ...
    for (const rk of [
      ...
      'GET /v1/handshakes',
      'POST /v1/deals/{dealId}/payments',
      'POST /v1/deals/{dealId}/payments/{payId}/void',
    ]) {
